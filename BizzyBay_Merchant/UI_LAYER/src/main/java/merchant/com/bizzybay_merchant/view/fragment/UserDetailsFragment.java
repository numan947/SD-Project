...
import com.merchant_example.interactor.GetUserDetailsUseCaseImpl;
...
import merchant.com.bizzybay_merchant.presenter.UserDetailsPresenter;
import merchant.com.bizzybay_merchant.view.UserDetailsView;
import merchant.com.bizzybay_merchant.view.activity.GenericEditView;
import merchant.com.bizzybay_merchant.view.component.MyPasswordTransformationMethod;
import merchant.com.merchant_data_layer.cache.TestUserDetailsCacheImpl;
...
import merchant.com.merchant_data_layer.repository.UserDetailsDataRepository;
...
public class UserDetailsFragment extends BaseFragment implements UserDetailsView,AppBarLayout.OnOffsetChangedListener, View.OnClickListener {
    ...
    protected void initializePresenter() {
        ...
        UserDetailsDataStoreFactory userDetailsDataStoreFactory = new UserDetailsDataStoreFactory(BizzyBayMerchant.getBizzyBayApplicationContext(),userDetailsCache);
